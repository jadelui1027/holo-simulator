...
class PlaymatManager:
    ...
    def load_deck_from_decklog(self, deck_code: str) -> int:
        """
    ...
    def create_card(self, card_number: str) -> Card:
    ...
    def place_card_by_number(self, zone: Zone, card_number: str,
                             face_up: Optional[bool] = None) -> bool:
        """Create and place a card by its card number."""
        card = self.create_card(card_number)
